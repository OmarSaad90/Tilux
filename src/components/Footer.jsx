      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-14">
          ...
          <div className="md:col-span-5">
            ...
            <p className="text-sm text-frost-muted leading-relaxed" style={{ maxWidth: '36ch' }}>
          ...
          <div className="md:col-span-3 md:col-start-7">
            <div className="text-[11px] text-frost-muted uppercase tracking-[0.15em] mb-4">Navigation</div>
            <ul className="flex flex-col gap-2.5">
              {navLinks.map((label) => (
                <li key={label}>
                  <a
                    href={`#${label.toLowerCase()}`}
                    className="text-sm text-frost-dim hover:text-frost transition-colors duration-200"
                  >
                    {label}
                  </a>
                </li>
          ...
          <div className="md:col-span-4 md:col-start-10">
            <div className="text-[11px] text-frost-muted uppercase tracking-[0.15em] mb-4">Contact</div>
            <div className="flex flex-col gap-2.5">
              ...
              <span className="text-sm text-frost-muted">Greater Toronto Area</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-5">
            {legalLinks.map((label) => (
              <a
                key={label}
                href="#"
                className="text-xs text-frost-muted hover:text-frost-dim transition-colors duration-200"
              >
                {label}
              </a>
            ))}
